...
def p_onlyNumber_expr(p): #Bryan Vargas
    '''onlyNumber : INTEGER
    | FLOAT'''
...
def p_while_expr(p):   #Carlos Moncayo
    '''while : WHILE OPEN_PARENTHESIS expBoolean CLOSE_PARENTHESIS OPEN_BRACE expression CLOSE_BRACE
...
def p_arrayFn_expr(p): #Maria Rivera
    ...
    | NAME POINT PUSH OPEN_PARENTHESIS item CLOSE_PARENTHESIS SEMICOLON
    | NAME POINT UNSHIFT OPEN_PARENTHESIS item CLOSE_PARENTHESIS SEMICOLON'''
...
def p_iniciarMap_expr(p): #Maria Rivera
    '''iniciarMap : NEW MAP OPEN_PARENTHESIS CLOSE_PARENTHESIS
                  | NEW MAP OPEN_PARENTHESIS tupla CLOSE_PARENTHESIS'''
...
def p_tupla_expr(p): #Maria Rivera
    ''' tupla : OPEN_BRACKET item COMMA item CLOSE_BRACKET
        | OPEN_BRACKET item COMMA item CLOSE_BRACKET COMMA tupla'''
